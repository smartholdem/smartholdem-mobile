<template>
  <div>
    <base-button type="primary" @click="showActions = !showActions" round icon class="position-absolute"
                 style="right:10px;bottom: 10px;height:3rem; width:3rem;">
    ...
    <div @click="showActions = false" v-if="showActions" class="row h-100 w-100 position-absolute"
      ...
      <div class="w-100 position-absolute bg-dark col-md-12 pt-4 pb-4" style="bottom:0;">
