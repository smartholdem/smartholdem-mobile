...
<style>
  .card-stats .info-icon.icon-gray {
    background: #fd5d93;
    background-image: -webkit-gradient(linear, right top, left bottom, from(#171415), color-stop(#9E9E9E), to(#E91E63));
    background-image: linear-gradient(to bottom left, #171415, #9E9E9E, #E91E63);
